...
# The TOP 5 best RTM Forged images at threshold 0.97
forged_paths = [
    "data_pipeline/raw/RTM/cpmv_2977.jpg",
    "data_pipeline/raw/RTM/splice_0449.jpg",
    "data_pipeline/raw/RTM/splice_0068.jpg",
    "data_pipeline/raw/RTM/cpmv_2648.jpg",
    "data_pipeline/raw/RTM/insert_0259.jpg"
]

# Flawless authentic RTM/MIDV500 images
auth_paths = [
    ...
    "reports/verified_docs/RTM_Auth_good_2554_img.jpg"
]
...
for i, item in enumerate(test_items):
    ...
    is_success = "SUCCESS" if t == verdict else "FAILED"
...
print("-" * 65)
print(f"\nAll tightly masked RTM documents saved to: {out_dir}/")
